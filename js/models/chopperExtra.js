function Chopper(ctx, x, y){
  ...
  this.img = new Image();
  this.img.src = "img/helicoptero-sprite-extra.png";
...
ChopperExtra.prototype.move = function(){
  this.ctx.drawImage(
    this.img,
    0,
...
ChopperExtra.prototype.draw = function(){
  this.animate();
...
ChopperExtra.prototype.dead = function(){
